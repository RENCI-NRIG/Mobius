...
public interface ComputeApi {
    ...
    @ApiOperation(value = "Request/modify compute resource for a workflow ", nickname = "computePost", notes = "Request/modify compute resource for a workflow ", response = MobiusResponse.class, tags={  })
    @ApiResponses(value = { 
