...
@Api(value = "sdxPrefix", description = "the sdxPrefix API")
public interface SdxPrefixApi {

    @ApiOperation(value = "Request to publish subnets and connect them at the SDX ", nickname = "sdxPrefixPost", notes = "Request to publish subnets and connect them at the SDX ", response = MobiusResponse.class, tags={  })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/sdxPrefix",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<MobiusResponse> sdxPrefixPost(@ApiParam(value = "" ,required=true )  @Valid @RequestBody SdxPrefix body
