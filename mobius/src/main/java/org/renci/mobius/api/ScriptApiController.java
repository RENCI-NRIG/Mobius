...
@Controller
public class ScriptApiController implements ScriptApi {
    ...
    public ScriptApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<MobiusResponse> scriptPost(@ApiParam(value = "" ,required=true )  @Valid @RequestBody ScriptRequest body
,@NotNull @ApiParam(value = "", required = true) @Valid @RequestParam(value = "workflowID", required = true) String workflowID
        ...
        if (accept != null && accept.contains("application/json")) {
            ...
            try {
                ...
                MobiusController.getInstance().processScriptRequest(workflowID, body);
