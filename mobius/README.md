...
- Design details can be found in Design.md
- Interface specifications can be found in Interface.md
- Code can be generated via swagger by referring to HowToGenerateCodeFromSwagger.md
