                ...
                */
                ...
                private void processNewReq(NewRequestInfo newReq, String orcaSliceID) {
                    ...
                    if(requestedTemplateType.startsWith(CondorBasicTypeName)){
                        ...
                        ndlReq = ndlManager.generateNewHadoopRequest(newReq, logger);
                    }
                        ...
                        ndlReq = ndlManager.generateNewMPIRequest(newReq, logger);
                    }
                    else {
                ...
                private String processModifyComputeReq(ModifyRequestInfo modReq, String orcaSliceID) {
                    ...
                    String sliceStatus = ndlManager.getSliceManifestStatus(currManifest, logger);
                    ...
                    ndlModReq = ndlManager.generateModifyComputeRequest(modReq, currManifest, logger);
