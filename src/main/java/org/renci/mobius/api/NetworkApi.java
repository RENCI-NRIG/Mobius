...
public interface NetworkApi {
    ...
    @ApiOperation(value = "Request/modify network resource for a workflow ", nickname = "networkPost", notes = "Request/modify network resource for a workflow ", response = MobiusResponse.class, tags={  })
    @ApiResponses(value = { 
    ...
    ResponseEntity<MobiusResponse> networkPost(@ApiParam(value = "" ,required=true )  @Valid @RequestBody NetworkRequest body,@NotNull @ApiParam(value = "", required = true) @Valid @RequestParam(value = "workflowID", required = true) String workflowID);
